...
import se.chimps.bitziness.core.endpoints.net.rest.spray.unrouting.Model.Request
import spray.http._
...
class MyController extends Controller {
  import se.chimps.bitziness.core.endpoints.net.rest.spray.unrouting.Model.Responses._
